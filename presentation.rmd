...
Solihull, Birmingham, Walsall, Sandwell, Wolverhampton against absolute numbers. Birminghas higher numbers but is average in proportion to it's population."  class="center"/>
</centre>
...
+ Ladywood - Birmingham (25)
+ St. Michael's - Coventry (18)
...
Walsall, Sandwell, Wolverhampton showing number of animal rescues per fiscal year 2013 - 2023" height="300" class="center"/>
<br>
...
+ When decomposed: clear increasing trend and annual seasonality
+ Examined as both monthly and rolling periods
+ Best performance with exponential smoothing and ARIMA
+ 

<centre>
<img src="./outputs/four_month_rolling_forecast.png" alt="Seasonal timeseries component for animal rescue data in West Midlands, showing trend annual seasonality and error"  height="300" class="center"/>
</centre>
...
.pull-right[
<centre>
<img src="./outputs/time_series_components.png" alt="Seasonal timeseries component for animal rescue data in West Midlands, showing trend annual seasonality and error"  height="600" class="center"/>
</centre>
]
...
+ Tokenised to words using `tidytext`, stopwords removed.
+ Lots of alternatives (e.g. dog, puppy, terrier etc.) - mapped with function.

<p float="left">
<img src="./outputs/animal_words2.png" alt="Word cloud of from animal rescue text, showing 'cat' and stuck' to be most frequent"  width="250" height = "250"/>
...
<!-- <img src="./outputs/animal_words2.png" alt="Word cloud of from animal rescue text, showing 'cat' and stuck' to be most frequent"  width="100" class="left"/><img src="./outputs/animal_bigrams2.png" alt="Word cloud of bi-grams from animal rescue text, showing 'cat stuck' to be most frequent"  width="100" class="right"/> -->
...
<centre>
<img src="./outputs/animals_by_region.png" alt="Bar chart showing animal type by region for animal rescues in the West Midlands, showing 'cat' to be most common, but significantly so in Birmingham"  height="600" class="center"/>
</centre>
...
+ Local (District) forecasts - help planning of resources
+ Times in the data:
  + Time of day analysis
  + Time taken for rescues
+ Compare to other call out data
  + Relative time taken
  + Effects on availability / opportunity cost
+ Augment future data capture:
